  ...
  return (
    <div className="grid grid-cols-2 h-screen">
      <div className="">
        ...
        {message && (
          <h1 className="bg-pink-300 text-black-300 2xl">{message}</h1>
        )}
        {success && (
          <h1 className="bg-green-300 text-black-300 2xl">
        ...
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
          <div className="mb-6">
            <form onSubmit={submitHandler}>
              ...
              <button
                type="submit"
                className="text-center w-full mt-3 rounded-b-lg bg-fuchsia-950 text-white
                                      py-2 px-3"
              >
                Update Your Details
              </button>
              ...
              <tbody>
                {bookeds.map((booked) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {booked.isPaid ? <p>Paid</p> : <h1>NOt Paid</h1>}
                    </td>
                    <td className="px-6 py-4">
                      {booked.isDeliverd ? (
                        booked.DeliverdAt.substring(0, 10)
                      ) : (
                        <h1> Not Visited</h1>
                      )}
                    </td>

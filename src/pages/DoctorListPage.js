...
import { createDoctor, deleteDoctor, listDoctors } from '../redux/actions/doctorActions'
...
const DoctorListPage = () => {
    ...
    const {loading:loaddingDelete,error:errorDelete,success:successDelete} = doctorDelete
    
    //Doctor List

    const doctorCreate = useSelector(state =>state.doctorCreate)
    const {loading:loaddingCreate,
        error:errorCreate,
    ...
    },[dispatch,navigate,userLogin,successDelete, successCreate,createdDoctor,errorCreate])
  ...
  return (
    ...
    <div className='grid grid-cols-3 gap-5'>
        ...
        <div className='col-span-1'>
            <button className=' bg-purple-300 text-pink-700 px-5 py-5'
                onClick={joinADoctor}
            >
                Join a Doctor
            </button>
